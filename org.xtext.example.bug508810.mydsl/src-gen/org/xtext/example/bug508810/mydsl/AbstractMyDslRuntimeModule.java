...
import org.xtext.example.bug508810.mydsl.generator.MyDslGenerator;
import org.xtext.example.bug508810.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import org.xtext.example.bug508810.mydsl.parser.antlr.MyDslParser;
import org.xtext.example.bug508810.mydsl.parser.antlr.internal.InternalMyDslLexer;
import org.xtext.example.bug508810.mydsl.scoping.MyDslScopeProvider;
import org.xtext.example.bug508810.mydsl.serializer.MyDslSemanticSequencer;
import org.xtext.example.bug508810.mydsl.serializer.MyDslSyntacticSequencer;
import org.xtext.example.bug508810.mydsl.services.MyDslGrammarAccess;
import org.xtext.example.bug508810.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/bug508810/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.bug508810.mydsl.MyDsl");
	}
