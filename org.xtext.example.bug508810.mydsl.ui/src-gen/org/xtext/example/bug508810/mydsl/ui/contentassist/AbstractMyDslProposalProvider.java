 ...
 */
package org.xtext.example.bug508810.mydsl.ui.contentassist;
...
public abstract class AbstractMyDslProposalProvider extends TerminalsProposalProvider {
	...
	public void completeGreeting_Parameters(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		completeRuleCall(((RuleCall)assignment.getTerminal()), context, acceptor);
	}
